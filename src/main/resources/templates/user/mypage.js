...
function moveSlide_1(num_1) {
  yslides_1.style.left = -num_1 * 801 + 'px';
  currentIdx_1 = num_1;
}
...
next_1.addEventListener('click', function () {
  ...
  moveSlide 함수 불러옴 */
  if (currentIdx_1 < slideCount_1 - 1) {
...
function moveSlide_2(num_2) {
  yslides_2.style.left = -num_2 * 801 + 'px';
  currentIdx_2 = num_2;
}
...
next_2.addEventListener('click', function () {
  ...
  currentIdx !==slideCount - 1 일때만 
  moveSlide 함수 불러옴 */
  if (currentIdx_2 < slideCount_2 - 1) {
...
function moveSlide_3(num_3) {
  yslides_3.style.left = -num_3 * 801 + 'px';
  currentIdx_3 = num_3;
}
...
next_3.addEventListener('click', function () {
  ...
  currentIdx !==slideCount - 1 일때만 
  moveSlide 함수 불러옴 */
  if (currentIdx_3 < slideCount_3 - 1) {
...
function moveSlide_4(num_4) {
  yslides_4.style.left = -num_4 * 801 + 'px';
  currentIdx_4 = num_4;
}
...
next_4.addEventListener('click', function () {
  ...
  currentIdx !==slideCount - 1 일때만 
  moveSlide 함수 불러옴 */
  if (currentIdx_4 < slideCount_4 - 1) {
...
function moveSlide_5(num_5) {
  yslides_5.style.left = -num_5 * 801 + 'px';
  currentIdx_5 = num_5;
}
...
next_5.addEventListener('click', function () {
  ...
  currentIdx !==slideCount - 1 일때만 
  moveSlide 함수 불러옴 */
  if (currentIdx_5 < slideCount_5 - 1) {
...
function moveSlide_6(num_6) {
  yslides_6.style.left = -num_6 * 801 + 'px';
  currentIdx_6 = num_6;
}
...
next_6.addEventListener('click', function () {
  ...
  currentIdx !==slideCount - 1 일때만 
  moveSlide 함수 불러옴 */
  if (currentIdx_6 < slideCount_6 - 1) {
